...
namespace VoxxWeatherPlugin.Utils
{
    internal class PlayerTemperatureManager
    {
        ...
        internal static void SetPlayerTemperature(float temperatureDelta)
        {
            ...
            {
                heatEffectVolume.weight = heatSeverity; // Only show heat effect if temperature > 0
            }
            if (freezeEffectVolume != null)
            {
                ...
                freezeEffectVolume.weight = Mathf.Min(coldSeverity/SnowPatches.frostbiteThreshold*0.9f, (0.1f*coldSeverity + 0.9f - SnowPatches.frostbiteThreshold)/(1f - SnowPatches.frostbiteThreshold));
            }
        }
